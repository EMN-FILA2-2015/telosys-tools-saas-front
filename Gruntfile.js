...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    connect: {
      options: {
        port: 9000,
        // Change '0.0.0.0' to 'localhost' to deny access to the server from outside.
        hostname: 'localhost',
        livereload: 35729
      },
      livereload: {
    ...
    watch: {
      ...
      injectSass: {
        files: [
          '<%= yeoman.client %>/{app,components,services}/**/*.{scss,sass}'],
        tasks: ['injector:sass']
      },
      sass: {
        files: [
      ...
      livereload: {
        files: [
          ...
          '!{.tmp,<%= yeoman.client %>}/{app,components,services}/**/*.mock.js',
